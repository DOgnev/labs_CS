...
namespace LAB2_case4
{
    class Intro
    {
        ...
        public String Task = "Задание 4. Написать программу, которая осуществляет циклический сдвиг литер в строке Str влево на заданное количество позиций.";
        public String TestCase = "[INFO] ТЕСТ. Исходная строка QWERTY. Задан сдвиг на 2 позиции. Ожидается результат ERTYQW";
