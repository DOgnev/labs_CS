...
namespace LAB2_case1
{
    class Intro
    {
        ...
        public String Task = "Задание 1. Написать программу, которая осуществляет циклический сдвиг литер в строке Str вправо на одну позицию.";
        public String TestCase = "[INFO] ТЕСТ. Исходная строка QWERTY. Ожидается результат YQWERT";
