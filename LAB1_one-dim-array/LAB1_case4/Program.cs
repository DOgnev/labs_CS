...
namespace LAB1_case4
{
    class Intro
    {
        ...
        public String Task = "Задание 4. Разработать приложение, которое находит наименьший элемент массива";
        public String TestCase = "[INFO]: ТЕСТ. Определение 5 элементов массива: 5, 4, 3, 2, 1 Ожидается результат: 1";
        ...
        static void Main(string[] args)
        {
            ...
            while (true)
            {
                ...
                if (C == "1")
                {
                    ...
                    Console.WriteLine("[MAIN]: Минимальный элемент массива: " + B.TestArray[0]);
                ...
                else if (C == "2")
                {
                    ...
                    Console.WriteLine("[MAIN]: Минимальный элемент массива: " + A[0]);
                    Console.WriteLine("[MAIN]: Нажмите любую клавишу для продолжения");
                    Console.ReadLine();
